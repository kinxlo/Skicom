            ...
            <div className="hidden xl:block">
              ...
              <div className="flex items-center gap-20">
                <div className="mt-5 flex flex-col gap-2">
                  <Link
                    href="/about"
                    className={`text-sm text-[#FFFFFF] ${pathname === "/about" ? "font-bold text-primary" : ""}`}
                  >
                    About
                  </Link>
                  <Link
                    href="/services"
                    className={`text-sm text-[#FFFFFF] ${pathname === "/services" ? "font-bold text-primary" : ""}`}
                  >
                    Services
                  </Link>
                </div>
                ...
                <div className="mt-5 flex flex-col gap-2">
                  <Link
                    href="/store"
                    className={`text-sm text-[#FFFFFF] ${pathname === "/store" ? "font-bold text-primary" : ""}`}
                  >
                    Store
                  </Link>
                  <Link
                    href="/contact"
                    className={`text-sm text-[#FFFFFF] ${pathname === "/contact" ? "font-bold text-primary" : ""}`}
                  >
                    Contact Us
                  </Link>
                </div>
            ...
            <div className="hidden xl:block">
              ...
              <div className="flex items-center gap-20">
                <div className="mt-5 flex flex-col gap-2">
                  <Link
                    href="/faq"
                    className={`text-sm text-[#FFFFFF] ${pathname === "/faq" ? "font-bold text-primary" : ""}`}
                  >
                    FAQ
                  </Link>
                  <Link
                    href="/blog"
                    className={`text-sm text-[#FFFFFF] ${pathname === "/blog" ? "font-bold text-primary" : ""}`}
                  >
                    Blog
                  </Link>
                </div>
                ...
                <div className="mt-5 flex flex-col gap-2">
                  <Link
                    href="/live-chat"
                    className={`text-sm text-[#FFFFFF] ${pathname === "/live-chat" ? "font-bold text-primary" : ""}`}
                  >
                    Live Chat
                  </Link>
                  <Link
                    href="/terms-condition"
                    className={`text-sm text-[#FFFFFF] ${pathname === "/terms-condition" ? "font-bold text-primary" : ""}`}
                  >
                    Terms & Condition
                  </Link>
                </div>
