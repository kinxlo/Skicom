    ...
    <main className="relative bg-[#F6F6F6]">
      <Wrapper>
        <section className="mx-auto w-11/12 pt-10 text-center 2xl:container">
          ...
          <p className="mt-2 text-4xl font-bold text-neutral-dark-1 lg:mt-0">
            See Where You’re Covered
          </p>

          <div className="relative mx-auto mt-4 lg:w-[800px]">
            <form className="">
              <Input
                type="text"
                className="mx-auto h-[50px] rounded-full bg-[#FFFFFF] pr-[110px] outline-none placeholder:text-sm lg:w-[800px]"
                placeholder="Search for our coverage locations"
              />

              <CustomButton
                variant="primary"
                className="right-0 top-0 mt-3 h-[33px] w-[103px] rounded-full lg:absolute lg:mt-0 lg:h-[50px]"
              >
                Search
              </CustomButton>
            </form>
